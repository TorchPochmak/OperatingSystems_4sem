...
//         block.is_block_"occupied" = false;
...
//     for (auto &block : info)
//     {
//         std::string small_info = "\t" + std::to_string(num++) + ". <" + block_status(block.is_block_"occupied") + "> <" + std::to_string(block.block_size) + ">\n";
//         blocks += small_info;
//     }
//     return blocks;
// }
